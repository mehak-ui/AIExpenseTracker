...
const Dashboard = () => {
    ...
    useEffect(() => {
        const load = async () => {
           try {
    // const s = await api.get(API_PATHS.DASHBOARD.SUMMARY);
    // console.log("SUMMARY", s.data);

    // const t = await api.get(API_PATHS.DASHBOARD.MONTHLY_TREND);
    // console.log("TREND", t.data);

    // const b = await api.get(API_PATHS.DASHBOARD.CATEGORY_BREAKDOWN);
    // console.log("BREAKDOWN", b.data);

    // const r = await api.get(API_PATHS.TRANSACTIONS.LIST, {
    //     params: { limit: 5 },
    // });
    // console.log("TRANSACTIONS", r.data);

    // const bd = await api.get(API_PATHS.BUDGETS.LIST);
    // console.log("BUDGETS", bd.data);
